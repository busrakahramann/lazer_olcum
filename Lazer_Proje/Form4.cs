...
namespace Lazer_Proje
{
    public partial class Form4 : Form
    {
        ...
        private void Form4_Load(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Hatalar where kanal='"+kanal1+"' ORDER BY tarihSaat", baglanti);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            SqlConnection baglanti = new SqlConnection("Data Source=192.168.0.111;Initial Catalog=LazerHatalari;User ID=sa;Password=a123456*");
            baglanti.Open();
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM Hatalar where kanal='" + kanal1 + "' and tarihSaat between '" + dateTimePicker1.Value.ToString() + "' AND '" + dateTimePicker2.Value.ToString() + "' order by tarihSaat", baglanti);
